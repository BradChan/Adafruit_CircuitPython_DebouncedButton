...
setup(
    name="adafruit-circuitpython-debouncedbutton",
    use_scm_version=True,
    setup_requires=["setuptools_scm"],
    description="CircuitPython button debouncer",
    long_description=long_description,
    long_description_content_type="text/x-rst",
    # The project's main homepage.
    url="https://github.com/adafruit/Adafruit_CircuitPython_DebouncedButton",
    # Author details
    ...
    py_modules=["adafruit_debouncedbutton"],
)
